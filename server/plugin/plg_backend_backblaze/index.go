...
func init() {
	...
	cachePath := filepath.Join(GetCacheDir(), BackblazeCachePath)
...
func (this Backblaze) Save(path string, file io.Reader) error {
	...
	backblazeFileDetail.path = GetAbsolutePath(GetCacheDir(), BackblazeCachePath+"data_"+QuickString(20)+".dat")
